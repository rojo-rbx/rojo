...
## Unreleased Changes
* Fixed crash when malformed CSV files are put into a project. ([#310](https://github.com/Roblox/rojo/issues/310))
* Fixed incorrect string escaping when producing Lua code from JSON files. ([#314](https://github.com/Roblox/rojo/issues/314))
* Fixed performance issues introduced in Rojo 6.0.0-rc.1. ([#317](https://github.com/Roblox/rojo/issues/317))
* Fixed `rojo plugin install` subcommand failing for everyone except Rojo developers. ([#320](https://github.com/Roblox/rojo/issues/320))
...
* Added support for turning `.json` files into `ModuleScript` instances ([#308](https://github.com/Roblox/rojo/pull/308))
* Added `rojo plugin install` and `rojo plugin uninstall` to allow Rojo to manage its Roblox Studio plugin. ([#304](https://github.com/Roblox/rojo/pull/304))
* Class names no longer need to be specified for Roblox services in Rojo projects. ([#210](https://github.com/Roblox/rojo/pull/210))
...
## [0.6.0 Alpha 3](https://github.com/Roblox/rojo/releases/tag/v0.6.0-alpha.3) (March 13, 2020)
* Added `--watch` argument to `rojo build`. ([#284](https://github.com/Roblox/rojo/pull/284))
* Added dark theme support to plugin. ([#241](https://github.com/Roblox/rojo/issues/241))
...
## [0.6.0 Alpha 2](https://github.com/Roblox/rojo/releases/tag/v0.6.0-alpha.2) (March 6, 2020)
...
## [0.5.4](https://github.com/Roblox/rojo/releases/tag/v0.5.4) (February 26, 2020)
...
## [0.6.0 Alpha 1](https://github.com/Roblox/rojo/releases/tag/v0.6.0-alpha.1) (January 22, 2020)

### General
* Added support for nested project files. ([#95](https://github.com/Roblox/rojo/issues/95))
* Added project file hot-reloading. ([#10](https://github.com/Roblox/rojo/issues/10)])
* Fixed Rojo dropping Ref properties ([#142](https://github.com/Roblox/rojo/issues/142))
...
## [0.5.3](https://github.com/Roblox/rojo/releases/tag/v0.5.3) (October 15, 2019)
* Fixed an issue where Rojo would throw an error when encountering recently-added instance classes.

## [0.5.2](https://github.com/Roblox/rojo/releases/tag/v0.5.2) (October 14, 2019)
* Fixed an issue where `LocalizationTable` instances would have their column order randomized. ([#173](https://github.com/Roblox/rojo/issues/173))

## [0.5.1](https://github.com/Roblox/rojo/releases/tag/v0.5.1) (October 4, 2019)
* Fixed an issue where Rojo would drop changes if they happened too quickly ([#252](https://github.com/Roblox/rojo/issues/252))
* Improved diagnostics for when the Rojo plugin cannot create an instance.
* Updated dependencies
    * This brings Rojo's reflection database from client release 395 to client release 404.

## [0.5.0](https://github.com/Roblox/rojo/releases/tag/v0.5.0) (August 27, 2019)
...
* Fixed `Rect` values being set to `0, 0, 0, 0` when synced with the Rojo plugin. ([#201](https://github.com/Roblox/rojo/issues/201))
* Fixed live-syncing of `PhysicalProperties`, `NumberSequence`, and `ColorSequence` values

## [0.5.0 Alpha 13](https://github.com/Roblox/rojo/releases/tag/v0.5.0-alpha.13) (August 2, 2019)
* Bumped minimum Rust version to 1.34.0.
* Fixed default port documentation in `rojo serve --help` ([#219](https://github.com/Roblox/rojo/issues/219))
* Fixed BrickColor support by upgrading Roblox-related dependencies

## [0.5.0 Alpha 12](https://github.com/Roblox/rojo/releases/tag/v0.5.0-alpha.12) (July 2, 2019)
* Added `.meta.json` files
    * `init.meta.json` files replace `init.model.json` files from Rojo 0.4.x ([#183](https://github.com/Roblox/rojo/pull/183))
    * Other `.meta.json` files allow attaching extra data to other files ([#189](https://github.com/Roblox/rojo/pull/189))
...
* Added a warning when a Rojo project contains keys that start with `$`, which are reserved names. ([#191](https://github.com/Roblox/rojo/issues/191))
...
* Changed the plugin to ignore unknown properties when live-syncing.
    * Rojo's approach to this problem might change later, like with a strict model mode ([#190](https://github.com/Roblox/rojo/issues/190)) or another approach.
...
## [0.5.0 Alpha 11](https://github.com/Roblox/rojo/releases/tag/v0.5.0-alpha.11) (May 29, 2019)
* Added support for implicit property values in JSON model files ([#154](https://github.com/Roblox/rojo/pull/154))
...
## 0.5.0 Alpha 10
* This release was a dud due to [issue #176](https://github.com/Roblox/rojo/issues/176) and was rolled back.
...
## [0.5.0 Alpha 8](https://github.com/Roblox/rojo/releases/tag/v0.5.0-alpha.8) (March 29, 2019)
* Added support for a bunch of new types when dealing with XML model/place files:
    ...
    * `Rect`
    * `Ref`
* Improved server instance ordering behavior when files are added during a live session ([#135](https://github.com/Roblox/rojo/pull/135))
* Fixed error being thrown when trying to unload the Rojo plugin.
* Added partial fix for [issue #141](https://github.com/Roblox/rojo/issues/141) for `Lighting.Technology`, which should restore live sync functionality for the default project file.

## [0.5.0 Alpha 6](https://github.com/Roblox/rojo/releases/tag/v0.5.0-alpha.6) (March 19, 2019)
* Fixed `rojo init` giving unexpected results by upgrading to `rbx_dom_weak` 1.1.0
* Fixed live server not responding when the Rojo plugin is connected ([#133](https://github.com/Roblox/rojo/issues/133))
...
## [0.5.0 Alpha 5](https://github.com/Roblox/rojo/releases/tag/v0.5.0-alpha.5) (March 1, 2019)
...
* Fixed plugin assets flashing in on first load ([#121](https://github.com/Roblox/rojo/issues/121))
* Changed Rojo's HTTP server from Rouille to Hyper, which reduced the release size by around a megabyte.
* Added property type inference to projects, which makes specifying services a lot easier ([#130](https://github.com/Roblox/rojo/pull/130))
* Made error messages from invalid and missing files more user-friendly

## [0.5.0 Alpha 4](https://github.com/Roblox/rojo/releases/tag/v0.5.0-alpha.4) (February 8, 2019)
* Added support for nested partitions ([#102](https://github.com/Roblox/rojo/issues/102))
* Added support for 'transmuting' partitions ([#112](https://github.com/Roblox/rojo/issues/112))
* Added support for aliasing filesystem paths ([#105](https://github.com/Roblox/rojo/issues/105))
* Changed Windows builds to statically link the CRT ([#89](https://github.com/Roblox/rojo/issues/89))

## [0.5.0 Alpha 3](https://github.com/Roblox/rojo/releases/tag/v0.5.0-alpha.3) (February 1, 2019)
* Changed default project file name from `roblox-project.json` to `default.project.json` ([#120](https://github.com/Roblox/rojo/pull/120))
...
* Fixed an in-memory filesystem regression introduced recently ([#119](https://github.com/Roblox/rojo/pull/119))

## [0.5.0 Alpha 2](https://github.com/Roblox/rojo/releases/tag/v0.5.0-alpha.2) (January 28, 2019)
...
* Fixed long-polling error caused by a promise mixup ([#110](https://github.com/Roblox/rojo/issues/110))

## [0.5.0 Alpha 1](https://github.com/Roblox/rojo/releases/tag/v0.5.0-alpha.1) (January 25, 2019)
...
## [0.5.0 Alpha 0](https://github.com/Roblox/rojo/releases/tag/v0.5.0-alpha.0) (January 14, 2019)
...
## [0.4.13](https://github.com/Roblox/rojo/releases/tag/v0.4.13) (November 12, 2018)
...
## [0.4.12](https://github.com/Roblox/rojo/releases/tag/v0.4.12) (June 21, 2018)
* Fixed obscure assertion failure when renaming or deleting files ([#78](https://github.com/Roblox/rojo/issues/78))
* Added a `PluginAction` for the sync in command, which should help with some automation scripts ([#80](https://github.com/Roblox/rojo/pull/80))

## [0.4.11](https://github.com/Roblox/rojo/releases/tag/v0.4.11) (June 10, 2018)
...
## [0.4.10](https://github.com/Roblox/rojo/releases/tag/v0.4.10) (June 2, 2018)
* Added support for `init.model.json` files, which enable versioning `Tool` instances (among other things) with Rojo. ([#66](https://github.com/Roblox/rojo/issues/66))
...
## [0.4.9](https://github.com/Roblox/rojo/releases/tag/v0.4.9) (May 26, 2018)
* Fixed warning when renaming or removing files that would sometimes corrupt the instance cache ([#72](https://github.com/Roblox/rojo/pull/72))
* JSON models are no longer as strict -- `Children` and `Properties` are now optional.

## [0.4.8](https://github.com/Roblox/rojo/releases/tag/v0.4.8) (May 26, 2018)
* Hotfix to prevent errors from being thrown when objects managed by Rojo are deleted

## [0.4.7](https://github.com/Roblox/rojo/releases/tag/v0.4.7) (May 25, 2018)
* Added icons to the Rojo plugin, made by [@Vorlias](https://github.com/Vorlias)! ([#70](https://github.com/Roblox/rojo/pull/70))
* Server will now issue a warning if no partitions are specified in `rojo serve` ([#40](https://github.com/Roblox/rojo/issues/40))

## [0.4.6](https://github.com/Roblox/rojo/releases/tag/v0.4.6) (May 21, 2018)
* Rojo handles being restarted by Roblox Studio more gracefully ([#67](https://github.com/Roblox/rojo/issues/67))
...
## [0.4.5](https://github.com/Roblox/rojo/releases/tag/v0.4.5) (May 1, 2018)
...
* Rojo now throws an error if no project file is found. ([#63](https://github.com/Roblox/rojo/issues/63))
* Fixed multiple sync operations occuring at the same time. ([#61](https://github.com/Roblox/rojo/issues/61))
* Partitions targeting files directly now work as expected. ([#57](https://github.com/Roblox/rojo/issues/57))

## [0.4.4](https://github.com/Roblox/rojo/releases/tag/v0.4.4) (April 7, 2018)
* Fix small regression introduced in 0.4.3

## [0.4.3](https://github.com/Roblox/rojo/releases/tag/v0.4.3) (April 7, 2018)
* Plugin now automatically selects `HttpService` if it determines that HTTP isn't enabled ([#58](https://github.com/Roblox/rojo/pull/58))
...
## [0.4.2](https://github.com/Roblox/rojo/releases/tag/v0.4.2) (April 4, 2018)
* Fixed final case of duplicated instance insertion, caused by reconciled instances not being inserted into `RouteMap`.
    * The reconciler is still not a perfect solution, especially if script instances get moved around without being destroyed. I don't think this can be fixed before a big refactor.

## [0.4.1](https://github.com/Roblox/rojo/releases/tag/v0.4.1) (April 1, 2018)
* Merged plugin repository into main Rojo repository for easier tracking.
* Improved `RouteMap` object tracking; this should fix some cases of duplicated instances being synced into the tree.

## [0.4.0](https://github.com/Roblox/rojo/releases/tag/v0.4.0) (March 27, 2018)
* Protocol version 1, which shifts more responsibility onto the server
    * This is a **major breaking** change!
    * The server now has a content of 'filter plugins', which transform data at various stages in the pipeline
    * The server now exposes Roblox instance objects instead of file contents, which lines up with how `rojo pack` will work, and paves the way for more robust syncing.
* Added `*.model.json` files, which let you embed small Roblox objects into your Rojo tree.
* Improved error messages in some cases ([#46](https://github.com/Roblox/rojo/issues/46))

## [0.3.2](https://github.com/Roblox/rojo/releases/tag/v0.3.2) (December 20, 2017)
* Fixed `rojo serve` failing to correctly construct an absolute root path when passed as an argument
* Fixed intense CPU usage when running `rojo serve`

## [0.3.1](https://github.com/Roblox/rojo/releases/tag/v0.3.1) (December 14, 2017)
* Improved error reporting when invalid JSON is found in a `rojo.json` project
    * These messages are passed on from Serde

## [0.3.0](https://github.com/Roblox/rojo/releases/tag/v0.3.0) (December 12, 2017)
* Factored out the plugin into a separate repository
* Fixed server when using a file as a partition
    * Previously, trailing slashes were put on the end of a partition even if the read request was an empty string. This broke file reading on Windows when a partition pointed to a file instead of a directory!
* Started running automatic tests on Travis CI (#9)

## [0.2.3](https://github.com/Roblox/rojo/releases/tag/v0.2.3) (December 4, 2017)
* Plugin only release
* Tightened `init` file rules to only match script files
    * Previously, Rojo would sometimes pick up the wrong file when syncing

## [0.2.2](https://github.com/Roblox/rojo/releases/tag/v0.2.2) (December 1, 2017)
* Plugin only release
* Fixed broken reconciliation behavior with `init` files

## [0.2.1](https://github.com/Roblox/rojo/releases/tag/v0.2.1) (December 1, 2017)
* Plugin only release
* Changes default port to 8000

## [0.2.0](https://github.com/Roblox/rojo/releases/tag/v0.2.0) (December 1, 2017)
