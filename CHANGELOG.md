...
* Added a new `rojo build` flag, `--plugin_autostart`, which adds a special marker to the built place file. When the place file is opened, the Rojo plugin will start immediately.
