...
return {
	...
	WrapLayer = {
		...
		properties = {
			...
			DebugMode = {
				name = "DebugMode",
				type = {type = "Enum", name = "WrapLayerDebugMode"},
				isCanonical = true,
				canonicalName = nil,
				serializedName = nil,
				scriptability = "None",
		...
		defaults = {
			BindOffset = CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),
			CageMeshId = "",
			...
			Puffiness = 1,
			ReferenceMeshId = "",
			ReferenceOrigin = CFrame.new(0, 0, 0, 1, 0, 0, 0, 1, 0, 0, 0, 1),
			ShrinkFactor = 0,
		},
	},
	WrapTarget = {
		...
		properties = {
			...
			DebugMode = {
				name = "DebugMode",
				type = {type = "Enum", name = "WrapTargetDebugMode"},
				isCanonical = true,
				canonicalName = nil,
				serializedName = nil,
				scriptability = "None",
